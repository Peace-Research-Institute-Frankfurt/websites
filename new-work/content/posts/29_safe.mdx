...
<Figure size="medium" src="safe-plan-new.png" caption="Der neue Grundriss des SAFE in Frankfurt" license="none" alt="TODO Alt text here" expandable={true} />

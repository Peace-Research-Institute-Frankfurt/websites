...
<IconGrid themes={[
  {icon: "zeit", copy: "Organisatorisch und finanziell umsetzbares (Anspar-)Modell, das eine Freistellung für einen Zeitraum von 6 bis 12 Wochen ermöglicht"},
  {icon: "gesundheit", copy: "Aus gesundheitlicher Sicht empfehlenswerte Arbeitsintensitäten in den Ansparzeiten"},
  {icon: "motivation", copy: "Erreichbare positive Effekte (Erholung, Steigerung der Kreativität und Motivation) während des Sabbaticals"},
  {icon: "planung", copy: "Auswirkungen von Kurzzeit-Sabbaticals auf die Projektbearbeitung und Ressourcenplanung"},
]}/>

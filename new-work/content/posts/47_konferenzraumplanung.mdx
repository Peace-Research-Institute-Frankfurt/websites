...
intro: Die Anforderungen an Meetingräume haben sich in den letzten Jahren stark verändert. Schnell und unkompliziert müssen sie sich an unterschiedliche Bedürfnisse anpassen lassen. Heiko Fleischmann und Dominik Kindlein von Raumwelten Heiss erläutern, wie man solche Räume plant.
---
...
<Figure size="full" src="plan-overview.png" alt="Alt text here"></Figure>
...
<Figure size="large" src="plan-detail.png" alt="Alt text here"></Figure>

...
short_title: Konferenzraumplanung
category: raum
hero_image: './assets/26_moxa9396-scaled.jpg'
hero_credit: © Moxy Europe
hero_credit_label: Foto
hero_portrait: './assets/heiko-dominik.jpg'
hero_portrait_alt: 'TODO'
intro: Die Anforderungen an Konferenzräume haben sich in den letzten Jahren stark verändert. Schnell und unkompliziert müssen sie sich an unterschiedliche Bedürfnisse anpassen lassen. Wir haben Heiko Fleischmann und Dominik Kindlein von Raumwelten Heiss gefragt, wie man an die Planung solcher Räume herangeht.
---

<InterviewQuestion q="Wie beginne ich mit der Planung eines Konferenzraums?">
...
<InterviewQuestion q="Konferenzraum aus? Welche Möglichkeiten bieten sich?">
...
<InterviewQuestion q="Wie lassen sich Sicherheit und Vertraulichkeit gewährleisten? Wie lassen sich Sicherheit und Vertraulichkeit gewährleisten?">

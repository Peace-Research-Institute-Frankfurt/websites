...
<IconGrid themes={[
  {icon: "gesamt", copy: "Wie wird mit der zu erwartenden weiteren Aufspaltung von Beschäftigtengruppen umgegangen? "},
  {icon: "team", copy: "Wie sozial- und organisationsverträglich ist dieses Konzept?"},
  {icon: "vernetzung", copy: "Berücksichtigen Team und Führungskräfte die Bedürfnisse von Remote-Arbeitenden oder müssen diese sich anpassen?"}
]}/>

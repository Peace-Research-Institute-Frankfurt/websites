...
<IconGrid themes={[
  {icon: "team", copy: "Erhöhter Abstimmungsaufwand teamintern und mit der Führungskraft"},
  {icon: "produktivitaet", copy: "Produktivitätseffekte für Akteur:innen und Projekte "},
  {icon: "attraktiv", copy: "Einfluss auf die Attraktivität als Arbeitgebende"},
  {icon: "stimmung", copy: "Auswirkungen auf das Betriebsklima und Umgang mit „Ungerechtigkeiten“, d. h. mit der unterschiedlich kurzfristigen Verfügbarkeit für Einsätze vor Ort"},
]}/>
...
<IconTile to="/experimentierraum-flexible-wissenschaftsarbeit#ortsflexible-arbeitsmoglichkeiten" eyebrow="Zuordnung im Experimentierraum" body="Quick Start — Ortsflexible und attraktive Arbeitsmöglichkeiten (OaA)" icon="place"/>

...
<DetailsGroup>
  ...
  <Details summary="Machine guns">
    ...
    **Submachine guns** are a hybrid between pistols and assault rifles and are relatively easy to operate. Light machine guns can fire in “rapid bursts to extended ranges”[^2].
    <Figure
      size="medium"
  ...
  <Details summary="Heavy machine guns">
    Belt-fed weapons that fire at high rates, supported by a tripod for stability.
  </Details>

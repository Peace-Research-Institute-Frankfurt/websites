...
<Quiz>
  <Question type="MultipleChoice" question="When did the issue of proliferation of small arms and light weapons surface on the international and regional arms control agenda?">
    <Choice value="1970s" />
    <Choice value="1980s" />
  ...
  <Question type="MultipleChoice" question="Is an AK 47 assault rifle...">
    <Choice correct="true" value="a small arm" />
    <Choice value="a light weapon" />
    <Choice value="none of the above" />
  </Question>

  <Question type="MultipleChoice" question="Top exporters are considered countries...">
  ...
  <Question type="MultipleChoice" question="Why are SALW so popular among non-state actors?" hint="More than one correct answer possible.">
  ...
  <Question type="MultipleChoice" question="What share of all murders of women and girls worldwide are committed using SALW?">

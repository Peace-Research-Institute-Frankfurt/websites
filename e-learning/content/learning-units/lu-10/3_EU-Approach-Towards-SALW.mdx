...
<Quiz>
  <Question type="MultipleChoice" question="Which one of these EU member states is not a major exporter of firearms?" hint="Multiple answers possible.">
  ...
  <Question type="MultipleChoice" question="The Firearms Directive 2021/555 sets out minimum criteria that member states have to implement in their national legislation with regard to…">

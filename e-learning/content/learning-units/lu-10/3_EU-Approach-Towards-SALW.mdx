...
<Figure
  size="medium"
  src="10_16_guns.jpg"
  caption="Labeled Handguns on the Floor."
  credit="© Fred Lubang"
  alt="A photo of numerous Handguns on the ground."
  license=""
></Figure>
...
<Callout title="Fact sheet: The EU strategy against illicit firearms and SALW (2018)">
  ...
  **Key aspects of the 2018 EU strategy:**
  ...
  <Figure
    ...
    caption="Council Conclusions on the Adoption of an EU Strategy Against Illicit Firearms and SALW"
    credit="European Council (2019)"
    alt=""
    license=""
    expandable={true}
  ></Figure>
...
<Quiz>
  <Question type="MultipleChoice" question="Which one of these EU member states is not a major exporter of firearms?" hint="More than one answer is correct.">
  ...
  <Question type="Radio" question="The Firearms Directive 2021/555 sets out minimum criteria that member states have to implement in their national legislation with regard to…">
    <RadioChoice value="the export and transit of civilian firearms to countries outside the European Union" />
    <RadioChoice value="the export and transit of military firearms to countries outside the European Union" />
    <RadioChoice value="the criminalisation of illicit firearms trafficking and brokering to conflict-affected countries" />
    <RadioChoice correct="true" value="the acquisition, possession and transfer of firearms and ammunition within the borders of the EU" />
    <RadioChoice value="the marking and tracing of seized firearms" />
  </Question>
</Quiz>

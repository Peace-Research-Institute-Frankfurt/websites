...
**Examples of pre-World War I export control**

<Timeline>
  <Event date="419" title="Rome edict prohibits teaching shipbuilding to Barbarians"/>
  <Event date="805" title="Charlemagne bans trade of swords and chainmail with enemies"/>
  <Event date="1853–1856" title="UK establishes export licensing during Crimean War"/>
  <Event date="1890" title="Brussels Act prohibits arms transfers to parts of Africa"/>
</Timeline>
...
**Examples of export control between WW I and WW II**

<Timeline>
  <Event date="1919" title="Nine states impose arms embargo on China during civil war"/>
  <Event date="1923" title="League of Nations requests tracking of arms trade"/>
  <Event date="1930s" title="Development of national export control laws in multiple countries"/>
</Timeline>
...
**Examples of export control during the Cold War**

<Timeline>
  <Event date="1950" title="Creation of the Coordinating Committee for Multilateral Export Controls (COCOM)"/>
  <Event date="1963" title="UN Security Council Resolution 181 establishes first UN arms embargo on South Africa"/>
  <Event date="1974" title="Creation of the Nuclear Suppliers Group focusing on nuclear-related items"/>
  <Event date="1985" title="Creation of the Australia Group focusing on chemical and biological weapons-related items"/>
  <Event date="1987" title="Creation of the Missile Technology Control Regime focusing on ballistic missile controls"/>
</Timeline>
...
**Examples of export control after the Cold War**

<Timeline>
  <Event date="1991" title="Establishment of the UN Register of Conventional Arms and P5 guidelines for arms transfers"/>
  <Event date="1993" title="EU adopts Common Foreign and Security Policy, enabling EU arms embargoes"/>
  <Event date="1994" title="Dissolution of COCOM"/>
  <Event date="1994" title="EU legislates regulation of intra and extra-EU trade in dual-use items"/>
  <Event date="1995" title="Creation of the Wassenaar Arrangement on export controls for arms and dual-use goods"/>
  <Event date="1998" title="EU adopts Code of Conduct on Arms Exports defining common export rules"/>
  <Event date="2001" title="UN adopts Programme of Action to combat illicit trade in small arms"/>
  <Event date="2004" title="Adoption of UN Security Council Resolution 1540"/>
  <Event date="2008" title="EU Common Position replaces EU Code of Conduct on arms exports"/>
  <Event date="2009" title="EU Dual Use Regulation adopted, consolidating EU export controls"/>
...
<Quiz>
  <Question type="MultipleChoice" question="Conventional arms…" hint="Select the correct statement.">
    <Choice value="are synonymous with small arms and light weapons" />
    <Choice correct="true" value="encompass major arms, small arms and light weapons and their ammunition" />
    <Choice value="encompass major arms and some types of weapons of mass destruction" />
  </Question>

  <Question type="MultipleChoice" question="COCOM was…" hint="Select the correct statement.">
    <Choice correct="true" value="an informal agreement between Western states to control exports to Warsaw Pact states" />
    <Choice value="the first multilateral treaty on the arms trade" />
    <Choice value="a confidence-building measure on missiles during the Cold War" />
  </Question>

  <Question type="MultipleChoice" question="Arms and dual-use export controls cover…" hint="Select the correct statement.">
    <Choice value="only physical items" />
    <Choice value="physical items and software" />
    <Choice correct="true" value="physical items as well as software and technology" />
  </Question>
</Quiz>


[^1]: Anthony, Ian (ed.). 1991. Arms Export Regulations. SIPRI. Oxford University Press, p. 3
[^2]: Henshaw, John. 1993. “The origins of COCOM: Lessons for contemporary proliferation control regimes”, The Henry L. Stimson Center, Report No. 7 (May)
[^3]: Bromley, Mark/Cooper, Neil/Holtom, Paul. 2012. “The UN Arms Trade Treaty: arms export controls, the human security agenda and the lessons of history”, in: International Affairs 88, (5) September 2012: 1029–48
[^4]: Bauer, Sibylle. 2010. “Post-cold war control of conventional arms”, in: Tan, Andrew (ed.) The Global Arms Trade: A Handbook. Routledge, p. 307.
[^5]: Maitre, Emmanuelle/Moreau-Brillatz, Sophie. 2022. “The Hague Code of Conduct and Space”, HCoC Research Papers, No. 10 (March), Foundation for Strategic Research: Paris

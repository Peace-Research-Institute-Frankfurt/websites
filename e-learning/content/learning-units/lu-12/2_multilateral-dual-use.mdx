...
According to one of the main operational provisions of UNSCR 1540 all states shall:
  ...
  <Quote type="document" fullDocument="https://www.un.org/en/sc/1540/1540-fact-sheet.shtm" cite='UNSCR 1540, United Nations Security Council, 2004'>
...
<Quiz>
  <Question type="Radio" question="Which of the multilateral export control regimes has the most participating states?">
    <RadioChoice value="The Australia Group" />
    <RadioChoice value="The Missile Technology Control Regime" />
    <RadioChoice correct="true" value="The Nuclear Suppliers Group" />
    <RadioChoice value="The Wassenaar Arrangement for Conventional Arms and Dual-use Goods and Technologies" />
  </Question>

  <Question type="Radio" question="Sort the four multilateral export control regimes discussed in this module from oldest to newest. A. The Australia Group; B. The Missile Technology Control Regime; C. The Nuclear Suppliers Group; D. The Wassenaar Arrangement." hint="Select the correct order.">
    <RadioChoice value="A, B, C, D" />
    <RadioChoice value="B, C, D, A" />
    <RadioChoice correct="true" value="C, A, B, D" />
    <RadioChoice value="D, B, A, C" />
  </Question>

  <Question type="Radio" question="Which of the following correctly describes the provisions and decisions of the multilateral export control regimes?">
    <RadioChoice value="Legally binding, decisions by consensus" />
    <RadioChoice correct="true" value="Politically binding, decisions by consensus" />
    <RadioChoice value="Legally binding, decisions by qualified majority" />
    <RadioChoice value="Politically binding, decisions by qualified majority" />
  </Question>
</Quiz>

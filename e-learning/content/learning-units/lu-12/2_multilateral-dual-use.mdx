...
<Figure
  size="medium"
  src="GraphOnRegimeFunctions.png"
...
**Global distribution of states in international non-proliferation and export control regimes**
<LayeredMap
  centerLat={20}
  centerLong={0}
  mapScale={1}
  ...
  title="Members of the CoCom treaty"
  description="Members of the CoCom treaty"
  legendTitle="Legend"
...
>
  ...
  <CountryStatisticsLayer
    colors={['#0D425B']}
    data={[
      {name: 'Australia', iso3: 'AUS', value: "Members of the CoCom treaty"},
      {name: 'Belgium', iso3: 'BEL', value: "Members of the CoCom treaty"},
      {name: 'Denmark', iso3: 'DNK', value: "Members of the CoCom treaty"},
      {name: 'West-Germany', iso3: 'DEU', value: "Members of the CoCom treaty"},
      {name: 'France', iso3: 'FRA', value: "Members of the CoCom treaty"},
      {name: 'Greece', iso3: 'GRC', value: "Members of the CoCom treaty"},
      {name: 'Italy', iso3: 'ITA', value: "Members of the CoCom treaty"},
      {name: 'Japan', iso3: 'JPN', value: "Members of the CoCom treaty"},
      {name: 'Canada', iso3: 'CAN', value: "Members of the CoCom treaty"},
      {name: 'Luxemburg', iso3: 'LUX', value: "Members of the CoCom treaty"},
      {name: 'Netherlands', iso3: 'NLD', value: "Members of the CoCom treaty"},
      {name: 'Norway', iso3: 'NOR', value: "Members of the CoCom treaty"},
      {name: 'Portugal', iso3: 'PRT', value: "Members of the CoCom treaty"},
      {name: 'Spain', iso3: 'ESP', value: "Members of the CoCom treaty"},
      {name: 'Turkey', iso3: 'TUR', value: "Members of the CoCom treaty"},
      {name: 'United Kingdom', iso3: 'GBR', value: "Members of the CoCom treaty"},
      {name: 'USA', iso3: 'USA', value: "Members of the CoCom treaty"},
    ]}
  />
</LayeredMap>
...
3.2 United Nations Security Council Resolution 1540

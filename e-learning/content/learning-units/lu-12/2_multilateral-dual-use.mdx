...
<LayeredMap
  ...
  title="Members of the CoCom agreement"
  description="Members of the CoCom agreement"
  legendTitle="Legend"
...
>
  ...
  <CountryStatisticsLayer
    colors={['#0D425B']}
    data={[
      {name: 'Australia', iso3: 'AUS', value: "Members of the CoCom agreement"},
      {name: 'Belgium', iso3: 'BEL', value: "Members of the CoCom agreement"},
      {name: 'Denmark', iso3: 'DNK', value: "Members of the CoCom agreement"},
      {name: 'West-Germany', iso3: 'DEU', value: "Members of the CoCom agreement"},
      {name: 'France', iso3: 'FRA', value: "Members of the CoCom agreement"},
      {name: 'Greece', iso3: 'GRC', value: "Members of the CoCom agreement"},
      {name: 'Italy', iso3: 'ITA', value: "Members of the CoCom agreement"},
      {name: 'Japan', iso3: 'JPN', value: "Members of the CoCom agreement"},
      {name: 'Canada', iso3: 'CAN', value: "Members of the CoCom agreement"},
      {name: 'Luxemburg', iso3: 'LUX', value: "Members of the CoCom agreement"},
      {name: 'Netherlands', iso3: 'NLD', value: "Members of the CoCom agreement"},
      {name: 'Norway', iso3: 'NOR', value: "Members of the CoCom agreement"},
      {name: 'Portugal', iso3: 'PRT', value: "Members of the CoCom agreement"},
      {name: 'Spain', iso3: 'ESP', value: "Members of the CoCom agreement"},
      {name: 'Turkey', iso3: 'TUR', value: "Members of the CoCom agreement"},
      {name: 'United Kingdom', iso3: 'GBR', value: "Members of the CoCom agreement"},
      {name: 'USA', iso3: 'USA', value: "Members of the CoCom agreement"},
    ]}
  />
</LayeredMap>

...
<LectureVideo smil="/lu14/HSFK-PC_LU14-CH04_13c_250217.smil" provider="video-stream">
  ...
  <Figure
    ...
    caption="Peter Woolcott, President of the Final UN Conference on the ATT, speaks at the special event marking the treaty's opening for signature (2013)."
  ...
  <Figure
    ...
    caption="Relevance of the ATT for EU Legislation (Symbolic Image)"

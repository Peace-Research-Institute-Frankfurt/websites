...
<Callout title="In focus: EU Institutions and Power Structure (by Lina Grip, 2017) ">
  ...
  **The European Parliament**
  ...
  <Figure
    ...
    credit="EU Non-Proliferation and Disarmament eLearning"
  ...
  <LectureVideo smil="/lu14/HSFK-PC_LU14-CH01_13c_250217.smil" provider="video-stream">
    ...
    **The introduction of a Common Foreign and Security Policy**
    ...
    <Figure
      size="medium"
      src="LU14_inhalte_grafiken_25022025_1.svg"
      caption="Agreeing on the CFSP (Symbolic Image)"
    ...
    **The establishment of the European External Action Service**
    ...
    <Figure
      ...
      alt="The entrance of the European External Action Service building at sunset, with a tree in bloom in front of it."
...
<p><small>Roles of EU Institutions in the Non-Proliferation and Disarmament Domain<br/>Source: Own elaboration</small></p>

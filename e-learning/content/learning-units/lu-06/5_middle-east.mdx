...
<Figure src='middle-east-raster.png' alt='Political map of northern Africa and the Middle East, countries from Libya to Iran are highlighted.' size="medium" caption="Proposed NWFZ in the Middle East" credit="PRIF/Natural Earth" license="cc-by-4"/>

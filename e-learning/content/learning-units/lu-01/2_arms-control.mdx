...
caption="Limitations of NATO and the Warsaw Pact according to CFE-Treaty"
...
<Figure
  ...
  caption="Limitations of missiles according to INF-Treaty"
...
<Figure
  ...
  caption="Preventing arms control vs. classical arms control"
  alt="Diagram showing the life-cycle of a weapon system with four phases (concept and technology development, system development and demonstration, production and deployment, sustainment and disposal) with an arrow labeled 'Life-cycle of a weapon system', and showing where preventive arms control and classical arms control apply during different stages of the lifecycle."
  credit="Grübelfabrik"
  license="cc-by-nc-sa-4"
></Figure>

...
<LectureVideo smil="lu20/lu20_vl2-1.smil" provider="video-stream">
...
<Timeline>
    <Event date="1918" title="Woodrow Wilson's Fourteen Points">
        ...
        [View Wilson’s whole message to congress at the Avalon Project.](https://avalon.law.yale.edu/20th_century/wilson14.asp)
...
<LectureVideo smil="lu20/lu20_vl2-2.smil" provider="video-stream">
...
<Quiz>
    ...
    <Question type="Radio" question="What was the main motivation for disarmament between the two world wars of the 20th century?">
        <RadioChoice value="make savings in the national defence budgets of the major states" />
        <RadioChoice correct="true" value=" Disarmament was conceived as one of the necessary foundations for peace between states." />
        <RadioChoice value=" inflict punishment on defeated countries (coercive disarmament)" />
        <RadioChoice value=" prevent the rearmament of Germany" />
        <RadioChoice value="ensure collective security by associating arms limitation with the creation of an international military force under the command of the League of Nations, made up of contiguous member states" />
    </Question>
    ...
    <Question type="MultipleChoice" question="What is the Baruch Plan?" hint="More than one answer is correct.">
        ...
        <Choice value=" a proposal to extend to all States the exchange of scientific information on nuclear energy for peaceful purposes" />
    </Question>

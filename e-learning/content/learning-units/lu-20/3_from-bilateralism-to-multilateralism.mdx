...
<LectureVideo smil="lu20/lu20_vl3-2" poster="https://nonproliferation-elearning.eu/learningunits/history/vid/lu20_vl3-2.jpg" provider="video-stream">
...
<Timeline>
    ...
    <Event date="May 1971" title="Agreement on ABM Treaty">
        <Figure
            size="medium"
            src="https://img.youtube.com/vi/xy-77tsg8V8/hqdefault.jpg"
...
- the place of the **Conference on Disarmament** in the arms control machinery (for further information on the UN Disarmament Machinery, see also [LU 18](/lu-18/))

<LectureVideo smil="lu20/lu20_vl3-3" poster="https://nonproliferation-elearning.eu/learningunits/history/vid/lu20_vl3-3.jpg" provider="video-stream">
...
<Quiz>
    <Question type="MultipleChoice" question="The ABM Treaty was an instrument designed to ..." hint="More than one answer is correct.">
        <Choice value="...increase the strategic defensive systems of the United States and the USSR." />
        <Choice correct="true" value="...establish a link between the limitation of strategic defensive armaments and the limitation of the strategic armaments of the two states parties." />
    ...
    <Question type="MultipleChoice" question="The Conference on Disarmament is..." hint="More than one answer is correct.">
        <Choice value="... a creation of the 1970s." />
        <Choice value=" .. a body of the United Nations." />
        <Choice correct="true" value="... intended to launch multilateral negotiations on arms control and disarmament." />
    ...
    <Question type="Radio" question="A prime example of multilateralism in nuclear arms control (non-proliferation and disarmament), the NPT ...">
        <RadioChoice value="... entered into force in 1968." />
        <RadioChoice value="... is a bilateral treaty between the US and the USSR." />
        <RadioChoice value="... originally entered into force for an unlimited period of time." />
        <RadioChoice value="... is a treaty banning nuclear weapons." />
        <RadioChoice correct="true" value="... is supported by a verification mechanism managed by the IAEA." />
    </Question>
</Quiz>

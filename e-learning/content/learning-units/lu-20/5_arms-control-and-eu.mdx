...
<Quiz>
    <Question type="MultipleChoice" question="When to date the birth of a specifically European non-proliferation policy?" hint="More than one answer is correct.">
        <Choice correct="true" value="EU countries have been cooperating in this area since the early 1970s within the framework of the European Political Cooperation Process." />
        <Choice value="With the entry into force of the Maastricht Treaty in 1993, the EU adopted and implemented a Common Foreign and Security Policy under which member states sought to agree on foreign and security policies." />
        <Choice correct="true" value="The EU’s contributions to the various non-proliferation and global security agendas at regional and global level were absent from European action before 2003." />
        <Choice correct="true" value="The adoption of the 2003 WMD Strategy marked the birth of the EU non-proliferation policy." />
    </Question>

    <Question type="MultipleChoice" question="What are the main features of the 2003 European Strategy?" hint="There is one correct answer.">
        <Choice value="a European threat assessment which covers all types of WMD" />
        <Choice value="a general set of measures and an innovative living action plan" />
...
What are the three concrete dimensions of “effective multilateralism”?">
        <Choice value="support for relevant multilateral agreements and frameworks" />
        <Choice value="financial and technical assistance to enable third States to implement their commitments" />
        <Choice value="economic and diplomatic action towards countries of proliferation concern" />
        <Choice correct="true" value="the implementation of targeted maritime and air counter-proliferation by ad hoc means" />
    </Question>
</Quiz>

...
<Quiz>
    <Question type="Radio" question="When to date the birth of a specifically European non-proliferation policy?">
        <RadioChoice value="EU countries have been cooperating in this area since the early 1970s within the framework of the European Political Cooperation Process." />
        <RadioChoice value="With the entry into force of the Maastricht Treaty in 1993, the EU adopted and implemented a Common Foreign and Security Policy under which member states sought to agree on foreign and security policies." />
        <RadioChoice value="The EU’s contributions to the various non-proliferation and global security agendas at regional and global level were absent from European action before 2003." />
        <RadioChoice correct="true" value="The adoption of the 2003 WMD Strategy marked the birth of the EU non-proliferation policy." />
    </Question>

    <Question type="MultipleChoice" question="What are the main features of the 2003 European Strategy?" hint="More than one answer is correct.">
        <Choice correct="true" value="a European threat assessment which covers all types of WMD" />
        <Choice correct="true" value="a general set of measures and an innovative living action plan" />
        <Choice value="a focus on the proliferation of WMD as a threat to the EU and its member states only" />
        <Choice correct="true" value="an emphasis on effective multilateralism, the promotion of global and regional stability and cooperation with key partner countries" />
    </Question>

    <Question type="MultipleChoice" question="What are the three concrete dimensions of “effective multilateralism”?" hint="More than one answer is correct.">
        <Choice correct="true" value="support for relevant multilateral agreements and frameworks" />
        <Choice correct="true" value="financial and technical assistance to enable third States to implement their commitments" />
        <Choice correct="true" value="economic and diplomatic action towards countries of proliferation concern" />
        <Choice value="the implementation of targeted maritime and air counter-proliferation by ad hoc means" />
    </Question>
</Quiz>

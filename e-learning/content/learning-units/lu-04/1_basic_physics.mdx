...
<LectureVideo smil="/lu04/HSFK-PC_LU04-CH01_15a_250311.smil" provider="video-stream">
  ...
  The large release of energy associated with fission, more 100 <Term t="MeV"/>/fission, is due to the fact that the fission products together have a smaller mass than the precursor nucleus, and this mass difference is released as energy. This is in line with Einstein’s famous formula E =  mc2, basically stating that energy (E) and mass (m) are, in equivalents (c stands for the speed of light in vacuum, a very large number).
  
  <Figure
    size="medium"
    src="AlbertEinstein.png"
    caption="Albert Einstein (1879-1955)"
    alt="Black and white portrait photograph of Albert Einstein with his characteristic curly gray hair and mustache, wearing a three-piece suit, appearing to be from the early 20th century."
    credit="Bundesarchiv"
    license="cc-by-sa-3"
  ></Figure>

  The fission process releases around 85 percent of the energy as the kinetic energy of the fragments. The rest is released in the form of radiation.
  ...
  The energetic fission fragments collide with surrounding matter and their kinetic energy is thus converted to heat via friction. In a nuclear reactor, this heat is used to produce electricity. In a nuclear weapon, it is used to cause an explosion.
...
<Callout title="Influences on critical mass">
  ...
  <Figure
    ...
    credit="EU Non-Proliferation and Disarmament Consortium eLearning"
    license="cc-by-nc-4"
    expandable={true}
  ></Figure>
...
<Figure
  ...
  caption="Radiation Types and their Degree of Penetration"

...
<Figure
  size="medium"
  src="hazmat.jpg"
  caption="OPCW in the field"
  credit="OPCW"
  license="cc-by-nc-2"
  alt="Four people walking in safety suits and gasmasks"
></Figure>
...
<LectureVideo smil="lu17/lu17_vl4-1.smil" subtitles="https://nonproliferation-elearning.eu/learningunits/disarmament-law/vid/lu17_vl4-1.vtt" provider="video-stream">
...
<Figure
  size="medium"
  src="national-authority.svg"
  caption=""
  credit="Anja Feix, Grübelfabrik / PRIF Frankfurt"
  license="cc-by-nc-4"
  alt=""
></Figure>
...
<Figure
  size="medium"
  src="national-investigations.svg"
  caption=""
  credit="Anja Feix, Grübelfabrik / PRIF Frankfurt"
  license="cc-by-nc-4"
  alt=""
...
<Figure
  ...
  alt="A rosary made from red and black beads."
></Figure>
...
<Figure
  ...
  credit="[U.S. Federal Bureau of Investigation](https://multimedia.fbi.gov/item?type=image&id=3355)"
  license="pd"
  alt="A gloved hand holds a petr dish for the photo. In it are several small, curious looking beans."
></Figure>
...
<Figure size="leftMargin"
  src="po.png"
  caption=""
  credit=""
  license="cc-by-2"
  alt="Orange background with writing on it: 210 Po"
></Figure>
...
On 12 February 2020, following a plea agreement in which the first charge was dismissed, the defendant was sentenced for the second charge to **two years’ supervised release and imprisonment for the time served**.
...
<Quiz>
  <Question type="MultipleChoice" question="National inspections are important, because" hint="Select all that apply.">
    <Choice correct="true" value="... their determinations of non-compliance could be the first step towards a criminal investigation." />
    ...
    <Choice correct="true" value="... they check compliance with national law as well as international law to the extent that the latter has been implemented in national legislation." />
  </Question>
  <Question type="Radio" question="To hold an individual or company criminally liable for possession of a chemical weapon, a prosecutor of a state can bring charges based on:">
    <RadioChoice value="Article VII of the CWC, which mentions penal measures." />
    <RadioChoice value="Article VII of the CWC, which mentions penal measures, provided the state has a monist system." />
    <RadioChoice correct="true" value="the state’s national implementing legislation for the CWC, which includes offences." />
    <RadioChoice value="the state’s national implementing legislation for the CWC, provided the state continues to be party to the CWC." />
  </Question>
</Quiz>

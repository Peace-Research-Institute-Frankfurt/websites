...
<Figure
  ...
  credit="[The European Union](https://www.consilium.europa.eu/en/about-site/copyright/)"
  license="all-reserved"
  alt="Josep Borrell Fontelles, a man with grey hair, glasses and a dark suit, seems to deliver a presentation; he holds a paper in his hand and is speaking."
></Figure>
...
<LectureVideo smil="lu17/lu17_vl5-1.smil" subtitles="https://nonproliferation-elearning.eu/learningunits/disarmament-law/vid/lu17_vl5-1.vtt" provider="video-stream">

The role and policies of the European Union in the field of arms control, non-proliferation and disarmament are discussed in [Learning Unit 14](/lu-14/). In this Learning Unit’s chapter, we focus on the **law that the European Union has developed in this field**, in accordance with its founding treaties.
...
Annex I – **List of dual use items**: This list implements internationally agreed dual-use controls including the Wassenaar Arrangement, the Missile Technology Control Regime (MTCR), the Nuclear Suppliers’ Group (NSG), the Australia Group and the Chemical Weapons Convention (CWC).
...
<Figure
  ...
  license="cc-by-4"
  alt="Poster reading: 'Export Control Forum 2018. An annual review of EU export controls.'"
></Figure>
...
<Figure
  ...
  caption="Digitally-colorized transmission electron microscopic image of Avian Influenza A H5N1 virus particles (seen in gold), grown in Madin-Darby Canine Kidney (MDCK) epithelial cells (seen in green)."
  credit="Cynthia Goldsmith / [Centers for Disease Control and Prevention](https://phil.cdc.gov/details.aspx?pid=1841)"
  license="pd"
  alt="Electron micrograph shows Avian influenza viruses grown in cells. The shape of the viruses vary from dot-like to rod-like."
></Figure>
...
<Figure
  size="medium"
  src="decision.png"
  caption="[Read full document](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32016D0849&from=EN)"
  credit="The European Union"
  license="pd"
  alt="The document's title page says: 'Council Decision 2016/849 of May 27 2016 concerning restrictive measures against the Democratic People's Republic of Korea and repealing Decision 2013/183/CFSP'"
></Figure>
...
<Figure
  size="leftMargin"
  src="isopropanol.png"
  caption="Ball and stick model of the isopropanol molecule."
  credit="Ben Mills and Jynto / [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Isopropanol-3D-balls.png)"
  license="pd"
  alt="Ball-and-stick model of the chemical isoprpanol."
></Figure>
...
<Quiz>
  <Question type="Radio" question="EU Regulations are...">
    <RadioChoice correct="true" value="...legally binding in their entirety to EU Member States" />
    <RadioChoice value="...legally binding to those to whom they are addressed." />

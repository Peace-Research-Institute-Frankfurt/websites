---
title: European Non-Proliferation and Disarmament Law
intro: 'Article 2 (1): Dual-use items shall mean items, '
reading_time: 2
order: 5
---
...
<Figure size="medium" src="fontelles.jpg" caption="" credit="[The European Union](https://www.consilium.europa.eu/en/about-site/copyright/)" license="all-reserved" alt="Josep Borrell Fontelles, a man with grey hair, glasses and a dark suit, seems to deliver a presentation; he holds a paper in his hand and is speaking."></Figure>

## Introduction: European Non-Proliferation and Disarmament Law

<LectureVideo smil="lu17/lu17_vl5-1.smil" poster="https://nonproliferation-elearning.eu/learningunits/disarmament-law/vid/lu17_vl5-1.jpg" subtitles="https://nonproliferation-elearning.eu/learningunits/disarmament-law/vid/lu17_vl5-1.vtt" provider="video-stream">
...
<Figure size="leftMargin" src="poster.png" caption="" credit="The European Union" license="cc-by-4" alt="Poster reading: 'Export Control Forum 2018. An annual review of EU export controls.'"></Figure>
...
<Figure size="full" src="avian-influenza.jpg" caption="" credit="Cynthia Goldsmith / [Centers for Disease Control and Prevention](https://phil.cdc.gov/details.aspx?pid=1841)" license="pd" alt="Electron micrograph shows Avian influenza viruses grown in cells. The shape of the viruses vary from dot-like to rod-like."></Figure>
...
<Figure size="medium" src="decision.png" caption="[Read full document](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX:32016D0849&from=EN)" credit="The European Union" license="pd" alt="The document's title page says: 'Council Decision 2016/849 of May 27 2016 concerning restrictive measures against the Democratic People's Republic of Korea and repealing Decision 2013/183/CFSP'"></Figure>
...
<Figure size="leftMargin" src="isopropanol.png" caption="" credit="Ben Mills and Jynto / [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Isopropanol-3D-balls.png)" license="pd" alt="Ball-and-stick model of the chemical isoprpanol."></Figure>
...
<Quiz>
  <Question type="MultipleChoice" question="EU Regulations are..." hint="Select all that apply.">
    <Choice correct="true" value="...legally binding in their entirety to EU States" />
    <Choice value="...legally binding to those to whom the are adressed." />
    <Choice value="...not legally binding" />
  </Question>
  <Question type="Radio" question="EU decisions...">
    <RadioChoice value="...are not legally binding" />
    <RadioChoice value="...include parts that are legally binding. " />
    <RadioChoice correct="true" value="...are legally binding to those to whom they are addressed." />
  </Question>
</Quiz>

[^1]:
    First conviction under UK’s BWC Act, Russell Moul and Yasemin Balci, Trust & Verify 147, October-December 2014. [^2]: Couple charged with BW offence
    in Germany, Thomas Brown, Trust & Verify 164, Summer 2019. [^3]: Former US congressional candidate attempts to buy radioactive substance on the dark web,
    Leanna Burnard, Trust & Verify 163, Spring 2019.

...
<Quiz>
  <Question type="Radio" question="EU Regulations are...">
    <RadioChoice correct="true" value="...legally binding in their entirety to EU States" />
    <RadioChoice value="...legally binding to those to whom the are adressed." />
    <RadioChoice value="...not legally binding" />
  </Question>

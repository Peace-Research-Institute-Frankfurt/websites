...
<Figure
  size="medium"
  src="exoskeleton.jpg"
  caption="An Exoskeleton makes it easier for an American soldier to lift heavy loads – here, for example, an artillery shell. Picture from an exoskeleton Operations and Maneuver and Technology Interchange meeting, 2018."
...
<Figure
  size="small"
  src="AltmannNano.jpg"
  caption="This book by Jürgen Altmann is still the seminal book on military nanotechnology."
  credit="Routledge"
  alt="Blue book cover with the title and name of the author."
  license=""
></Figure>

<p><small>Footnote: [^9]</small></p>

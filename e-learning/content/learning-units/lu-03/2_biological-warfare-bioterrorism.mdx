...
<Figure
  ...
  caption="Technical Institute of Science and Microbiology Stepnogorsk, Kazakhstan "
...
<LectureVideo smil="/lu03/LU03.03_final.smil" provider="video-stream">
  ...
  <Figure
    ...
    caption="The interior of a pharmaceutical or chemical laboratory with a bench in the centre and books and papers on shelves around the walls "
  ...
  <Figure
    size="medium"
    src="Nixon.png"
    caption="US President Richard Nixon"
    credit="National Archives and Records Service/public domain"
...
<Callout title="Case study US programme">
  ...
  <LayeredMap
    ...
    title=" Map showing locations of US research production facilities "
    description="Map showing locations of US research production facilities"
    legendTitle="Legend"
...
<Callout title="Case study Soviet programme">
  ...
  <LayeredMap
    ...
    layout="large"
    legendPosition="bottom-left"
    title="Map showing locations of Soviet research facilities"
    description="Map showing locations of Soviet research facilities"
    legendTitle="Legend"
    credit="Data: Natual Earth. Graphic: PRIF"
    license="cc-by-4"
  >

...
<Callout title="Case study US programme">
  ...
  <Figure
    size="medium"
    src="Locations_of_US_bioweapon_research.png"
    caption="Locations of US bioweapon research "
    credit="PRIF (CC-BY-SA)"
    alt="Locations of US bioweapon research "
    license=""
  ></Figure>
...
<Callout title="Case study Soviet programme">
  ...
  <Figure
    size="medium"
    src="Soviet_facilities.png"
    caption="Biopreparat controlled institutes involved in or supporting biological weapon development in the Soviet Union"
    credit="PRIF (CC-BY-SA)"
    alt="Soviet facilities"
    license=""
  ></Figure>

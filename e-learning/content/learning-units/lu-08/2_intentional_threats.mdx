...
<Figure
  ...
  credit="Grübelfabrik"
  alt="Schematic drawing of a satellite „zapping“ a missile with some electronic ray"
  license="cc-by-nc-sa-4"
></Figure>
...
<Quiz>
  <Question type="MultipleChoice" question="Space hybrid operations…">
    <Choice value="can be easily attributed" />
    <Choice value="cannot undermine an adversary’s capabilities" />
    <Choice value="cannot be used for harmful purposes" />
    <Choice correct="true" value="are conducted in the ‘grey zone’ between war and peace" />
  </Question>

  <Question type="MultipleChoice" question="Dual-use technology…">
    <Choice value="integrates both civilian and industrial functionalities" />
    <Choice correct="true" value="has military and commercial potential" />
    <Choice value="is utilised primarily for deep space exploration" />
    <Choice value="is primarily designed to serve as a space weapon" />
  </Question>

  <Question type="MultipleChoice" question="What do kinetic space weapons primarily aim to achieve?">
    <Choice value="Temporary disruption of satellite electronics" />
    <Choice value="Reversible interference with the electromagnetic spectrum" />
    <Choice correct="true" value="Irreversible destruction of space systems" />
    <Choice value="Manipulation of GPS signals" />
  </Question>

  <Question type="MultipleChoice" question="Which nation(s) have successfully tested direct ascent kinetic anti-satellite weapons as of August 2023?">
    <Choice correct="true" value="United States, China, India and Russia" />
    <Choice value="Russia, France, Japan and Germany" />
    <Choice value="India, Brazil, South Korea and Canada" />
    <Choice value="United Kingdom, Australia, China and Japan" />
  </Question>

  <Question type="MultipleChoice" question="Which type of space weapon can disrupt satellite electronics, corrupt data and cause processors to restart?">
    <Choice correct="true" value="Cyberspace weapons" />
    <Choice value="Directed energy space weapons" />
    <Choice value="Electronic space weapons" />
    <Choice value="Kinetic space weapons" />
  </Question>

  <Question type="MultipleChoice" question="Which of the following countries has NOT successfully tested kinetic direct ascent anti-satellite weapons?">
    <Choice value="India" />
    <Choice value="Russia" />
    <Choice correct="true" value="France" />
    <Choice value="China" />
  </Question>
</Quiz>

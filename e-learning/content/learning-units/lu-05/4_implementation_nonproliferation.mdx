...
<LectureVideo smil="/lu05/HSFK-PC_LU05-CH04_08d_240527.smil" provider="video-stream">
  ...
  <Figure
    ...
    alt=""
    credit="Courtesy of the International Atomic Energy Agency"
    license=""
  ></Figure>
...
As at 31 March 2023, Additional Protocols are in force with 141 States and EURATOM. A further 13 States have signed an Additional Protocol but have not yet brought it into force. The IAEA is also applying the measures of the Additional Protocol in Taiwan, and under the Joint Comprehensive Plan of Action (JCPOA), Iran has agreed to implement its protocol provisionally.

...
<LectureVideo smil="lu07/HSFK-PC_LU07-PC05.smil" provider="video-stream">
  ...
  **Missile Production Capabilities before the 1980s**
  ...
  <Figure
    src="LU07_inhalte_grafiken_f_03012025_pfade_3.svg"
  ...
  <Figure
    ...
    caption="Production of ICBM vs. Production of ASCM"
    alt="Production of ICBM vs. Production of ASCM"
    credit="Grübelfabrik"
    license="cc-by-nc-sa-4"
    size="medium"
  ></Figure>
...
>
  ...
  <CountryStatisticsLayer
    colors={['var(--orange-60)', 'var(--blue-60)']}
    data={[

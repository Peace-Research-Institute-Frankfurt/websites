...
<LectureVideo smil="lu07/HSFK-PC_LU07-PC01.smil" provider="video-stream">
  On a basic level, the term missile describes a single-use, airborne, self-propelled and unmanned weapon system designed to travel a certain distance and neutralise a target, typically through kinetic effects. Despite their differences, all missiles share several common components found in nearly every type of missile.
	...
	<Figure
		src="Components_of_a_missile.png"
		caption="Components of a missile"
		alt="Components of a missile"
		credit="Grübelfabrik"
  ...
  Missiles can be launched from air-based, surface-based or subsurface-based launchers. Air-based launchers include fixed-wing aircraft (fighter jets and bombers), as well as rotary-wing aircraft (helicopters). Surface-based platforms include surface vessels (e.g. guided missile destroyers), ground-mobile launchers or stationary ground-based launchers. Subsurface-based platforms refer to submarines and in the not too distant future are also likely to include unmanned underwater vehicles (UUVs).
	...
	<Figure
		src="LU07_inhalte_grafiken_f_03012025_pfade_5.svg"
		caption="Types of Missile Launchers"
		alt="Types of Missile Launchers"
		credit="Grübelfabrik"
    license="cc-by-nc-sa-4"
		size="medium"
	></Figure>
...
<LoopVideo
  src="/Assets/LU01_Icon---LOOP-outputWEB.mp4"
  caption="Dual-capable missile"
  credit="Grübelfabrik"
  license="cc-by-nc-sa-4"
/>
...
<Timeline>
  ...
  <Event date="1983" title="Tomahawk cruise missile">
  ...
  <Event date="1983" title="Pershing II">
  ...
  <Event date="2003" title="AGM-158A JASSM">
...
<LectureVideo smil="lu07/HSFK-PC_LU07-PC02.smil" provider="video-stream">
  ...
  The trajectory of a ballistic missile includes three phases: the boost phase, midcourse phase and terminal phase[^2].
	...
	<Figure
		src="LU07_inhalte_grafiken_f_03012025_pfade_2.svg"
		caption="Trajectory of a ballistic missile"
		alt="Trajectory of a ballistic missile"
		credit="Grübelfabrik"
    license="cc-by-nc-sa-4"
		size="medium"
	></Figure>
...
- **Intercontinental ballistic missiles (ICBMs)**: Greater than 5,500 km
	...
	<Figure
		src="LU07_inhalte_grafiken_f_03012025_pfade_4.svg"
		caption="Ballistic missile categories by range (thresholds may vary)"
		alt="Ballistic missile categories by range (thresholds may vary)"
		credit="Grübelfabrik"
    license="cc-by-nc-sa-4"
		size="medium"
	></Figure>
  ...
  Most ballistic missiles are surface launched from missile silos or ground-mobile launchers, and sub-surface launched from ballistic missile submarines. Some states also deploy air-launched ballistic missiles and are exploring integration on surface vessels. The majority of ballistic missiles today serve land-attack purposes, with a focus on stationary point or area targets. A few states are developing or deploying anti-ship ballistic missiles capable of engaging moving maritime targets. This includes the Chinese DF-21D anti-ship ballistic missile and the American Precision Strike Missile Inc. 2 currently under development, also referred to as the Land-Based Anti-Ship Missile
	...
	<Figure
		src="Dong-Feng_26.JPG"
		caption="DF-26 as seen at a military parade held in Beijing 2015"
		alt="DF-26 as seen at a military parade held in Beijing 2015"
		credit="IceUnshattered/Wikimedia"
    license="cc-by-sa-4"
		size="medium"
	></Figure>
...
<Figure
  ...
  credit="Tasnim News Agency/Wikimedia"
  license="cc-by-4"
...
<Figure
  ...
  credit="Boevaya mashina/Wikimedia"
  license="cc-by-sa-4"
...
>
  <CountryStatisticsLayer
    ...
    data={[
      {name: 'Australia', iso3: 'AUS', value: "States confirmed to operationally deploy ballistic missiles"},
      {name: 'China', iso3: 'CHN', value: "States confirmed to operationally deploy ballistic missiles"},
      {name: 'France', iso3: 'FRA', value: "States confirmed to operationally deploy ballistic missiles"},
      {name: 'India', iso3: 'IND', value: "States confirmed to operationally deploy ballistic missiles"},
      {name: 'Iran', iso3: 'IRN', value: "States confirmed to operationally deploy ballistic missiles"},
      {name: 'Israel', iso3: 'ISR', value: "States confirmed to operationally deploy ballistic missiles"},
      {name: 'Lithuania', iso3: 'LTU', value: "States confirmed to operationally deploy ballistic missiles"},
      {name: 'Norway', iso3: 'NOR', value: "States confirmed to operationally deploy ballistic missiles"},
      {name: 'Poland', iso3: 'POL', value: "States confirmed to operationally deploy ballistic missiles"},
      {name: 'Russia', iso3: 'RUS', value: "States confirmed to operationally deploy ballistic missiles"},
      {name: 'United Kingdom of Great Britain and Northern Ireland', iso3: 'GBR', value: "States confirmed to operationally deploy ballistic missiles"},
      {name: 'United States of America', iso3: 'USA', value: "States confirmed to operationally deploy ballistic missiles"},
    ]}
  />
</LayeredMap>
...
<Figure
  src="LU07_inhalte_grafiken_f_03012025_pfade_1.svg"
  caption="Illustration of the flight phases of a 'hypersonic' missile: take-off - separation - gliding flight - attack"
...
<LectureVideo smil="lu07/HSFK-PC_LU07-PC03.smil" provider="video-stream">
  ...
  The term “one-way attack” distinguishes between drone munitions that can return to their operator after launch and those that cannot. Examples of the former include multi-use, multi-purpose drones such as the American MQ-9 Reaper, whereas examples of the latter include the Iranian Shahed 131/136 drone.
	...
	<Figure
		src="2023_IRGC_Aerospace_Force_achievements_Exhibition_in_Qom_33.jpg"
		caption="Iranian Shahed 136 exhibited in Qom, Iran, 2023"
		alt="Iranian Shahed 136 exhibited in Qom, Iran, 2023"
		credit="Tasnim News Agency/Wikimedia"
    license="cc-by-4"
		size="medium"
	></Figure>
...
<Figure
  src="LU07_inhalte_grafiken_22012025_nachlieferung.svg"

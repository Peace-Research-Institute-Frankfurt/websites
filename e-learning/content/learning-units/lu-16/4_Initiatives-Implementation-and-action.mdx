---
title: Initiatives, Implementation and Action
intro: ''
order: 4
reading_time: 15
---
...
<Figure
  size="medium"
  src="table_large.jpg"
  caption="Conference booth International Gender Champions Geneva"
  credit="ITU / V. Arce"
  license="cc-by-2"
  alt="TODO"
></Figure>
...
<LectureVideo smil="lu16/lu16_vl4-1.smil" subtitles="https://nonproliferation-elearning.eu/learningunits/gender/vid/lu16_vl4-1.vtt" provider="video-stream">
...
<Figure
  size="medium"
  src="timeline-foreign-policy.svg"
  caption=""
  ...
  license="cc-by-2"
  alt="Timeline shows timeline (2014-2020) and some developments regarding feminist foreign policy."
></Figure>

## Initiatives and Actions in Promoting Gender and Disarmament

<LectureVideo smil="lu16/lu16_vl4-2.smil" subtitles="https://nonproliferation-elearning.eu/learningunits/gender/vid/lu16_vl4-2.vtt" provider="video-stream">
...
<LectureVideo smil="/lu16/ext/igc_whatisigc.smil" subtitles="null" provider="video-stream">
...
- Gender and sexual based violence in conflict

## Quiz

<Quiz>
  <Question type="Radio" question="Which country first announced the adoption of a Feminist Foreign Policy in 2014?">
    <RadioChoice value="Canada" />
    <RadioChoice value="Mexico" />
    <RadioChoice correct="true" value="Sweden" />
    <RadioChoice value="Germany" />
  </Question>
  <Question type="MultipleChoice" question="Which are goals of a Feminist Foreign Policy approach?" hint="More than one answer is correct.">
    <Choice correct="true" value="Break down culturally constructed barriers" />
    <Choice correct="true" value="Focus on human security" />
    <Choice value="Increase military expenditure to protect citizens" />
    <Choice correct="true" value="Intersectionality" />
  </Question>
</Quiz>

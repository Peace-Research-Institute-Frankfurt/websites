...
<LectureVideo smil="/lu13/HSFK-PC_LU13-CH02_17b_250422.smil" provider="video-stream">
  ...
  <Figure
    ...
    caption="Knowing Treaty Obligations (Symbolic Image)"
    alt=""
    credit="Grübelfabrik"
  ...
  >
    <CountryStatisticsLayer
      colors={["var(--orange-70)", "var(--green-60)"]}
      data={[
        { name: "India", iso3: 'IND', value: "India" },
        { name: "Pakistan", iso3: 'PAK', value: "Pakistan" }
      ]}
    />
  </LayeredMap>

...
<LectureVideo smil="/lu11/HSFK-PC_LU11-CH01_13a_250122.smil" provider="video-stream">
  ...
  <Figure
    size="medium"
    src="treaty-limited-equipment.png"
...
<DetailsGroup>
  <Details summary="Information exchange">
  ...
  <Details summary="Notification thresholds">
  ...
  <Details summary="Risk reduction mechanisms">
...
<Quiz>
  <Question type="MultipleChoice" question="In the CFE Treaty, battle tanks and heavy artillery pieces had the same upper limit for both sides. Was this upper limit:">
    <Choice value="30.000" />
    <Choice correct="true" value="20.000" />
    <Choice value="6.800" />
    <Choice value="2.000" />
  </Question>

  <Question type="MultipleChoice" question="There are three central instruments for conventional arms control in Europe. These are:">
    <Choice value="NPT, INF, NEW START" />
    <Choice value="CD, OSCE, EEAS" />
    <Choice correct="true" value="VD, CFE, OST" />
    <Choice value="EU, NATO, SEATO" />
  </Question>
</Quiz>

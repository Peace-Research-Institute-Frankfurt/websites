...
<LayeredMap
  ...
  title="Map Showing Member States of NATO and Warsaw Pact"
  description="Map Showing Member States of NATO and Warsaw Pact"
  legendTitle="Legend"
  credit="Natual Earth. Graphic: PRIF"
  license="cc-by-4"
>
  <CountryStatisticsLayer
    colors={['var(--blue-60)', 'var(--orange-60)']}
    data={[

      //NATO
    {name: 'Belgium', iso3: 'BEL', value: "NATO"},
    {name: 'Canada', iso3: 'CAN', value: "NATO"},
    ...
    {name: 'USA', iso3: 'USA', value: "NATO"},

      //Warsaw Pact
    {name: 'Albania', iso3: 'ALB', value: "Warsaw Pact"},
    {name: 'Bulgaria', iso3: 'BGR', value: "Warsaw Pact"},
    {name: 'Poland', iso3: 'POL', value: "Warsaw Pact"},
    {name: 'Romania', iso3: 'ROU', value: "Warsaw Pact"},
    {name: 'Czech Republic', iso3: 'CZE', value: "Warsaw Pact"},
    {name: 'Slovakia', iso3: 'SVK', value: "Warsaw Pact"},
    {name: 'Hungary', iso3: 'HUN', value: "Warsaw Pact"},
    {name: 'Russia', iso3: 'RUS', value: "Warsaw Pact"},
    {name: 'Ukraine', iso3: 'UKR', value: "Warsaw Pact"},
    {name: 'Armenia', iso3: 'ARM', value: "Warsaw Pact"},
    {name: 'Azerbaijan', iso3: 'AZE', value: "Warsaw Pact"},
    {name: 'Georgia', iso3: 'GEO', value: "Warsaw Pact"},
    {name: 'Lithuania', iso3: 'LTU', value: "Warsaw Pact"},
    {name: 'Latvia', iso3: 'LVA', value: "Warsaw Pact"},
    {name: 'Belarus', iso3: 'BLR', value: "Warsaw Pact"},
    {name: 'Moldova', iso3: 'MDA', value: "Warsaw Pact"},
    {name: 'Estonia', iso3: 'EST', value: "Warsaw Pact"},
    {name: 'Kazakhstan', iso3: 'KAZ', value: "Warsaw Pact"},
    {name: 'Uzbekistan', iso3: 'UZB', value: "Warsaw Pact"},
    {name: 'Tajikistan', iso3: 'TJK', value: "Warsaw Pact"},
    {name: 'Kyrgysztan', iso3: 'KGZ', value: "Warsaw Pact"},
    {name: 'Turkmenistan', iso3: 'TKM', value: "Warsaw Pact"},
...
<BarGraph
  ...
  xAxis="Year"
  xAxisTitle="Year"
  yAxisTitle="Volume of Military Expenditure in US$ (in billions)"
  colorRangeStart="#CED9DE"
  colorRangeEnd="#0D425B"
  maxValue={700}
  title="Military Expenditure in Europe, 1992–2024"
  description="Military expenditure in Europe, 1992–2024 (in US$ b., at constant 2024 prices and exchange rates)."
  legendTitle="Military Expenditure in Europe, 1992–2024"
  caption="Military expenditure in Europe, 1992–2024 (in US$ b., at constant 2024 prices and exchange rates)."
  credit="Data: [SIPRI Military Expenditure Database](https://milex.sipri.org/sipri), Graphic: PRIF"
/>
...
<BarGraph
  ...
  xAxis="Year"
  xAxisTitle="Year"
  yAxisTitle="Volume of Military Expenditure in US$ (in millions)"
  colorRangeStart="#CED9DE"
  colorRangeEnd="#0D425B"
  maxValue={140}
  title="Russian military expenditure 1992–2024 (in US$ m., at constant 2024 prices and exchange rates)."
  description="Russian military expenditure 1992–2024 (in const. 2024 US$ m.)"
  legendTitle="Russian military expenditure 1992–2024"
  caption="Russian Military Expenditure 1992–2024 (in US$ m., at constant 2024 prices and exchange rates)."
  credit="Data: [SIPRI Military Expenditure Database](https://milex.sipri.org/sipri), Graphic: PRIF"
/>
...
In the national strategies as well as NATO documents, the emphasis was on augmenting deterrence needs, with arms control and risk reduction seen as ‘complementing’ these efforts.
  ...
  <Quote type="document" fullDocument="https://mid.ru/en/foreign_policy/news/1913546" cite='Statement by the Ministry of Foreign Affairs of the Russian Federation'>

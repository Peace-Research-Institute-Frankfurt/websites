...
<LectureVideo smil="lu02/HSFK-PC_LU02-CH01_11a_241127.smil" provider="video-stream">
  The many different types of chemical warfare agents <Term t="CW"/> all served specific military objectives. Although some warfare agents are extremely poisonous and lethal in small amounts, killing was often not the primary purpose for their use.

  Because they are toxic, chemical warfare agents force soldiers to don physical protection in the form of gas masks and special clothing. This degrades their combat effectiveness considerably.

  Besides hampering movement, a soldier in full protective uniform will experience sensory isolation, have reduced visibility and a limited ability to communicate. Not to mention, eating and drinking become more complicated.
  ...
  The many different types of chemical warfare agents all served specific military objectives. Although some warfare agents are extremely poisonous and lethal in small amounts, killing was often not the primary purpose for their use.
...
<Figure
  src="The three main types of non-conventional weaponry and crossover weapon categories.png"
...
**Trigger warning, variant 1, flipcards**
<FlipCards>
  <Card size="medium" front="Trigger warning">
...
**Trigger warning, variant 2, tabs, first tab text only**
<Tabs>
  <Tab title="Warning!">Trigger warning!</Tab>
  <Tab title="Picture">
    <Figure
      src="Iranian mustard agent casualty, Iran-Iraq war 1984.jpeg"
      alt="Photograph showing the back of a person affected by mustard agent exposure, with large blisters visible on the skin."
...
**Trigger warning, variant 3, callout**
<Callout title="Injuries caused by mustard gas">
  Trigger warning! The following photo shows a person seriously injured by mustard gas. This picture can be very disturbing. Click on ‘Expand’ if you still want to see it.
  <Figure
    src="Iranian mustard agent casualty, Iran-Iraq war 1984.jpeg"
    alt="Photograph showing the back of a person affected by mustard agent exposure, with large blisters visible on the skin."
    size="medium"
...
**Trigger warning, variant 3, tabs, first tab pixelated image**
<Tabs>
  <Tab title="Warning!">
...
<Figure
src="Spraying of Agent Orange over Indochina during Operation Ranch Hand.jpeg"
alt="Spraying of Agent Orange over Indochina during Operation Ranch Hand"
size="medium"
caption="Spraying of Agent Orange over Indochina during Operation Ranch Hand"
credit=""
license=""
></Figure>

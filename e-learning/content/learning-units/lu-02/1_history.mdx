...
<Figure
  ...
  credit="German National Archives (public domain)"
  license="pd"/>

[A figure is missing here!]

Figure Caption: Early  French protection against gas attacks, 1915
...
Because they are toxic, chemical warfare agents force soldiers to don physical protection in the form of gas masks and special clothing. This degrades their combat effectiveness considerably. Besides hampering movement, a soldier in full protective uniform will experience sensory isolation, have reduced visibility and limited ability to communicate. Not to mention, eating and drinking become more complicated.
...
One important characteristic of chemical weapons is that to reach their target, the chemical agent must travel through the air. Because of this, effectiveness depends on weather conditions, such as local winds, humidity and landscape features. Using an obstruction between the agent and the target offers protection. A gas mask, protective clothing or sealed spaces enable soldiers and civilians to survive in a contaminated environment.
...
Modern chemical warfare (G) began on 22 April 1915 with the release by German Imperial troops of a massive chlorine cloud near Ypres, Belgium. As the war progressed, competition between increasingly lethal agents and improvements in chemical defence intensified. By late 1918, a total of 50 percent of all shells fired were chemical. The Armistice also ended chemical warfare in Europe, which had killed many tens of thousands of soldiers and civilians and injured possibly up to a million people. Toxic agents scarred many survivors for life, for instance, through blindness or damaged lungs.

<Figure
  src="British_55th_Devision_gas.jpg"
  alt=""
  size="medium"
  caption="The German spring offensive, 1918"
  credit="IWM Q 11586, Thomas Keith Aitken (IWM Non-Commercial Licence)"
  license="pd"/>

Expectations were that if the war had continued into 1919, CW use would have surpassed that of conventional munitions. A new type of agent, lewisite, was on board transport ships en route from the USA to Europe when the arms fell silent.
...
<Timeline>
  <Event date="1914–1918" title="">
    World War I: generalised CW use from April 1915 onwards
  </Event>
  <Event date="1919" title="">
    British use of airdropped DM bombs in North Russia
  </Event>
  <Event date="1921" title="">
    Soviet CW use during the Tambov uprising
  </Event>
  <Event date="1921–1927" title="">
    Spain and France launch several CW attacks to suppress the Berber uprising in the Rif, Morocco
  </Event>
  <Event date="1928" title="">
    Italy drops mustard bombs during the colonisation campaign in Libya
  </Event>
  <Event date="1934" title="">
    Following their invasion of Xinjiang, the Soviets airdrop mustard agent bombs forcing the Chinese defenders of Dawan Cheng to retreat
  </Event>
  <Event date="1935–1939" title="">
    Repeated Italian use of mustard bombs during the campaign in Abyssinia (Ethiopia)
  </Event>
  <Event date="1937–1939" title="">
    Japanese troops use  various types of CW during the campaigns in China
  </Event>
  <Event date="1939–1945" title="">
    World War II : sporadic CW incidents reported. With the exception of Japanese use in a few campaigns, CW does not appear to have been part of the belligerents’ military strategies.
  </Event>
</Timeline>
...
Between 1962 and 1970 several allegations were made that Egypt resorted to CW (G) during its intervention against royalist forces in the civil war in Yemen. Some 40 incidents were reported.
...
Figure Caption: Preparing for a terrorist strike with chemical or biological weapons
...
Figure Caption: Decontamination operation after the Aum Shinrikyo sarin attack on the Tokyo subway.
...
Al-Qaeda in Iraq became the Islamic State in Iraq and the Levant (ISIL). In Syria, the group began experimenting with chlorine-filled mortar grenades, which in 2015 became more of a method of warfare than terrorism. It then expanded the practice in its operations against Kurds in Iraq. The OPCW (G) also confirmed cases of ISIL using mustard agent in Syria and Iraq.

## Quiz
<Quiz>
  <Question type="MultipleChoice" question="What is a chemical weapon? ">
    <Choice value="It is impossible to precisely define a chemical weapon, because the boundaries with biological weapons, on the one hand, and nuclear weapons, on the other are fuzzy" />
    <Choice value="A chemical weapon is any toxic substance with the potential to harm living organisms that is used as a method of warfare." />
  ...
  <Question type="MultipleChoice" question="How likely are terrorist attacks with chemical weapons?" hint="Multiple correct answers are possible">
    ...
    <Choice correct value="Increased awareness of the threat and international cooperation have made it more difficult for terrorists to acquire the domestic and international technology needed to produce chemical weapons."/>
    <Choice correct value="Human factors such as internal group dynamics and pressure for early use to demonstrate technological prowess to members and the outside world will tend to contribute to the failure of a chemical weapon programme."/>
    <Choice value="The dynamics inside Aum Shinrikyo were unique. Future terrorist groupings will be able to overcome the impediments the movement faced." />
  </Question>
  ...
  <Question type="MultipleChoice" question="What is the difference between an incapacitant and an irritant? ">
    ...
    <Choice value="Irritants are solids, whereas incapacitants are much more similar to nerve agents." />
    <Choice value="Legally speaking there is no difference because both types are authorised for use as crowd control agents." />
    <Choice value="Incapacitants are toxic substances, whereas irritants belong to a category of agents that falls between chemical and biological weapons." />
  </Question>
  ...
  <Question type="MultipleChoice" hint="Multiple correct answers are possible" question="Should I avoid using the term ‘gas’ when referring to chemical weapons? ">
    ...
    <Choice value="Yes. If you use the term ‘gas’, your audience will know immediately that you have limited knowledge on the subject matter." />
    <Choice correct value="Yes. Today’s chemical warfare agents are mostly liquids or solids and only some types of agents used in World War I were gases in the true sense of the word."/>
  </Question>
</Quiz>

...
<Figure src="opcw-training.jpg" alt="" size="medium" caption="CBRN response training in the field." credit="OPCW" license=""></Figure>
...
<Quiz>
  <Question
    type="MultipleChoice"
    question="The CWC does not apply to terrorism because as an international treaty it only governs inter-state behaviour."
  >
    <Choice
      correct
      value="The statement is incorrect. State parties have national obligations under the CWC and must enact, implement and enforce national legislation so as to make the convention applicable to non-state actors on its territory."
    />
  ...
  <Question type="MultipleChoice" question="Is chlorine banned under the Chemical Weapons Convention?" hint="Multiple correct answers are possible">
    ...
    <Choice
      correct
      value="No. While chlorine is not listed in the Schedules, the Chemical Weapons Convention still regulates its possible uses through the General Purpose Criterion."
    />
  ...
  <Question type="MultipleChoice" question="Has the CWC superseded the 1925 Geneva Protocol?">
    ...
    <Choice
      correct
      value="No. The Geneva Protocol forms the foundation of the UN Secretary-General’s investigative Mechanism and the provisions in the Rome Statute making chemical warfare a war crime."
    />

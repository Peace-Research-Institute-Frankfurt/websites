---
title: Introduction
intro: Cybersecurity  has become one of the buzzwords of our time. On a very general level, it describes all measures and practices protecting and defending computer networks, servers, computers – basically all computerized items, e.g. modern cars, planes, smart homes – from infiltration to hostile takeover.
order: 1
reading_time: 3
---

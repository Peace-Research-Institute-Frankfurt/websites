...
-	CRISPR
-	DETECTR
-	Deterrence (but here it is not deterrence in the armament sense, but that legal mechanisms deter the misuse of biotechnology)
-	DNA
-	Genetic engineering
...
<Aside title="Proteomic and Lipidomic">

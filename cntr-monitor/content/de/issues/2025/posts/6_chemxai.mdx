...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td rowspan="4"> <ul> <li>Bildung/Ethik</li> <li>Zusammenarbeit mit der OVCW</li> <li>KI-Regulierung</li> <li>KI-Sicherheitsmechanismen</li> <li>Zugangsbeschränkung</li> </ul> </td>
        </tr>
        <tr>

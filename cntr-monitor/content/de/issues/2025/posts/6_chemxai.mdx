...
<table style={{ margin: '38px' }}>
    ...
    <tbody>
        <tr>
            ...
            <td rowspan="4" style={{ padding: '18px' }}> <ul> <li>Bildung/Ethik</li> <li>Zusammenarbeit mit der OVCW</li> <li>KI-Regulierung</li> <li>KI-Sicherheitsmechanismen</li> <li>Zugangsbeschränkung</li> </ul> </td>
        </tr>
        <tr>
